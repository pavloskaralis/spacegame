...
class GameLogic  {
    constructor() {
        this.ussSchwarzenegger = new Uss (20, 5, 7);
...
///// Class Interaction Methods /////
    alienAttackResult () {
        ...
        this.ussSchwarzenegger.currentHull === this.ussSchwarzenegger.startingHull ? 
            ussDodge() : 
            (this.ussSchwarzenegger.currentHull > 0 ? ussTakeDamage() : ussDestroyed());
    }
    ussAttackResult () {
        ...
        this.alienFleet[0].currentHull === this.alienFleet[0].startingHull ? 
            alienDodge() : 
            (this.alienFleet[0].currentHull > 0 ? alienTakeDamge() : alienDestroyed());
    }
    ussAttackResultShield () {
        ...
        this.alienBoss.currentShield === this.alienBoss.startingShield ? 
            shieldDodge() : 
            ((this.alienBoss.currentShield > 0) ? shieldTakeDamage() : shieldDestroyed());
    }
    enemyCounterAttack () {
    ...
    enemySneakAttack () {
        ...
        this.ussSchwarzenegger.currentHull === this.ussSchwarzenegger.startingHull ? 
           ussDodgeSA() : 
           (this.ussSchwarzenegger.currentHull > 0 ? ussTakeDamageSA() : ussDestroyedSA());
    } 
...
/////Randomizer Methods/////
    ...
    randomHealthBonus () {
        this.alienFleet.length !== this.startingFleetSize ? (Math.random() <= .7 ? 
            (this.ussSchwarzenegger.currentHull += 1) && alert(this.ussSchwarzenegger.alerts["repaired"]()) : 
...
/////Game Progression Methods/////
    ...
    endGame () {
        ...
        this.alienBoss.currentHull <= 0 ? 
            win() : 
            (this.ussSchwarzenegger.currentHull > 0 ? draw() : lose());
